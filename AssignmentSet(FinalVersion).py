...
class MainApp(Tk):
    ...
    def __init__(self, *kw, **kwarg):
        ...
        self.frame = Frame(self, bg = "#d9d9d9")
        self.frame.pack(fill="both", expand=1)


        # labels/text
        self.l1 = Label(self.frame, text='Assignments:', bg = "#d9d9d9", font = 15)
        self.l2 = Label(self.frame, text='Enter Assignment Title: ', bg = "#d9d9d9")
        self.l3 = Label(self.frame, text='Choose Subject: ', bg = "#d9d9d9")
        self.l4 = Label(self.frame, text='Enter Topic: ', bg = "#d9d9d9")
        self.l5 = Label(self.frame, text='Enter Date-Set: ', bg = "#d9d9d9")
        self.l6 = Label(self.frame, text='Enter Date-Due: ', bg = "#d9d9d9")
        self.l7 = Label(self.frame, text='Title', bg = "#d9d9d9")
        self.l8 = Label(self.frame, text='Subject', bg = "#d9d9d9")
        self.l9 = Label(self.frame, text='Topic', bg = "#d9d9d9")
        self.l10 = Label(self.frame, text='Date Set', bg = "#d9d9d9")
        self.l11 = Label(self.frame, text='Date Due', bg = "#d9d9d9")
    ...
    def add_assignment(self):
        ...
        if len(title) == 0:
            messagebox.showinfo('Empty Entry', 'Enter assignment title')
        elif len(subject) == 0:
    ...
    def listUpdate(self, title, subject, topic, date_set, date_due):
        ...
        # inserts values into listbox from database
